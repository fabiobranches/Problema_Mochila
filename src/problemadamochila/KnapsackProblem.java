...
//***********************
    ...
    public static void main(String[] args) {
        System.out.println("Solução para o problema da mochila com algoritmo genético. ");
        System.out.println("Primeiro, vc irá digitar a quantidade dos itens que deseja na mochila.");
        System.out.println("Depois disso, iremos fazer mais algumas perguntas para solucionar o problema.");
        ...
        System.out.println( "\nInsira o nome do arquivo de saída desejado:");
        nomeArquivo = scanner.nextLine();
        
        while(nomeArquivo.isEmpty() || nomeArquivo.length() == 0 || nomeArquivo.equals("") || nomeArquivo.equals(" ")){
            System.out.println( "\nInsira o nome do arquivo de saída desejado:");
            nomeArquivo = scanner.nextLine();
        }
        
        System.out.println("O nome de arquivo escolhido foi '"+nomeArquivo+"'");
        

        try {
                File file_name = new File(nomeArquivo);
                if(file_name.exists()) {
                    file_name.delete();
                }
